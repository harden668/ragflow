...
Example: general/v2/`,
  ...
  The above is the content you need to summarize.`,
      ...
      kingdeeDescription:
        'A component for connecting to Kingdee K/3 Cloud system to perform financial and supply chain operations.',
      exeSQLDescription:
...
[Insert text here]`,
    ...
    llmTools: {
      ...
      kingdee: {
        ...
        params: {
          entity_type:
            'The type of entity to query (material, customer, sale_order, purchase_order, inventory, production_order)',
          conditions: 'Query conditions as list of dictionaries',
          fields: 'Fields to return in the query result',
