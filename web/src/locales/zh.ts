...
以上就是你需要总结的内容。`,
      ...
      serverUrl: '服务器URL',
      accountId: '账套ID',
      enterAccountId: '请输入账套ID',
      username: '用户名',
      enterUsername: '请输入用户名',
      password: '密码',
      enterPassword: '请输入密码',
      languageCode: '语言代码',
      organizationNumber: '组织编号',
      appId: '应用ID',
      enterAppId: '请输入应用ID',
      appSecret: '应用密钥',
      enterAppSecret: '请输入应用密钥',
      queryConfiguration: '查询配置',
      pageRank: '页面排名',
...
以上就是你需要总结的内容。`,
      ...
      kingdee: '金蝶K/3 Cloud',
      kingdeeDescription:
        '该组件用于连接金蝶K/3 Cloud系统，执行财务和供应链相关操作。',
      exeSQLDescription:
...
[在此处插入文本]`,
    ...
    llmTools: {
      ...
      kingdee: {
        name: '金蝶K/3 Cloud',
        description: '用于查询金蝶K/3 Cloud系统数据的工具',
        params: {
          entity_type:
            '查询实体类型（物料、客户、销售订单、采购订单、库存、生产订单）',
          conditions: '查询条件列表',
          fields: '返回字段列表',
          limit: '返回记录数量限制',
        },
