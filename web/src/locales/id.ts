export default {
  translation: {
    ...
    knowledgeDetails: {
      ...
      uploadDescription:
        'RAGFlow mendukung pengunggahan file secara tunggal atau batch. ',
      chunk: 'Potongan',
      bulk: 'Massal',
      cancel: 'Batal',
    ...
    fileManager: {
      ...
      uploadTitle: 'Klik atau seret file ke area ini untuk mengunggah',
      uploadDescription:
        'RAGFlow mendukung pengunggahan file secara tunggal atau batch. Untuk RAGFlow yang dideploy secara lokal: batas ukuran total file per unggahan adalah 1GB, dengan batas unggahan batch sebanyak 32 file. Tidak ada batasan jumlah total file per akun.',
